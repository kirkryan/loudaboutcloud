...
Well, there is a handy way of hosting a site using GitHub and a static site generator such as Gatsby that will allow you to not only have a great site up and running quickly, but also teaches you a bit about GitHub actions and CI/CD in the process.
